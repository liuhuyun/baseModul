package com.app.basemodule.imageloader;
...
public class ImageLoaderUtils {
    ...
    public static void showImageView (Context context, String url, final LinearLayout bgLayout) {
        Glide.with (context).load (url).asBitmap ()
                //                .error (errorimg)// 设置错误图片
    ...
    public static void showImageView (Context context, String url, final FrameLayout frameBg) {
        Glide.with (context).load (url).asBitmap ()
                //                .error (errorimg)// 设置错误图片
    ...
    public static void showImageViewBlur (Context context, String url,
     ...
     * @param imgeview 组件
     */
    public static void showCircleImage (Application context, String url, ImageView imgeview) {
     ...
     * @param imgeview 组件
     */
    public static void showImageViewToCircleAndBlur (Context context, String url,
                                                     ImageView imgeview) {
        Glide.with (context).load (url)
                //                .error (errorimg)// 设置错误图片
     ...
     * @param imgeview 组件
     */
    public static void showImageViewToRoundedCorners (Context context, String url,
                                                      ImageView imgeview) {
        Glide.with (context).load (url)
                //                .error (errorimg)// 设置错误图片
     ...
     * @param imgeview 组件
     */
    public static void showImageViewToMask (Context context, String url, ImageView imgeview) {
        Glide.with (context).load (url)
                //                .error (errorimg)// 设置错误图片
